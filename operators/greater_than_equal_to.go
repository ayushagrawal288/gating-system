...
type GreaterThanEqualTo struct {
}

func (o *GreaterThanEqualTo) IsValid(key string, value string, attributes map[string]interface{}) (bool, error) {
	...
	case float64:
		...
		return t >= v, nil
	default:
		return false, &custom_errors.InvalidOperator{Type: expectedType, Operator: GREATER_THAN_EQUAL_TO, Key: key}
	}
}
