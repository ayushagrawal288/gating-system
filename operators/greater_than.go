...
func (o *GreaterThan) IsValid(key string, value string, attributes map[string]interface{}) (bool, error) {
	...
	case float64:
		...
		return t > v, nil
	default:
		return false, &custom_errors.InvalidOperator{Type: expectedType, Operator: GREATER_THAN, Key: key}
